...
//        ControladorReservas controladorReservas = new ControladorReservas(repositorioReservas, repositorioCotas);
//
...
//        // Reservar
//        try {
//            Reserva reserva = controladorReservas.criarReserva(LocalDateTime.now(),LocalDateTime.of(2025, 10, 22, 12, 30) ,usuario, bem);
...
//            Reserva reservaB = null;
//            try {
//                reservaB = controladorReservas.criarReserva(LocalDateTime.of(2025, 1, 7, 23, 59, 59), LocalDateTime.of(2025, 10, 10, 10, 10), usuarioB, bemB);
//            } catch (ReservaJaExisteException | PeriodoJaReservadoException | DadosInsuficientesException | ForaPeriodoException |
...
//                e.printStackTrace();
//            }
//        } catch (ReservaNaoExisteException | CotaJaReservadaException | PeriodoNaoDisponivelParaReservaException e) {
//            e.printStackTrace();
